...
- (id)initWithURL:(NSURL *)url {
	if ((self = [super init])) {
		_photoURL = [url copy];
        NSLog(@"_%@",[_photoURL absoluteString]);
        NSString * tmp = [[_photoURL absoluteString] stringByReplacingOccurrencesOfString:@".png" withString:@"_s.png"];
        UIImage *image = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:tmp];
...
//            [[NSOperationQueue mainQueue] addOperation:op];
            ...
            @try {
                ...
                id <SDWebImageOperation> _webImageOperation = [manager downloadImageWithURL:_photoURL
                                                           options:0
...
//                                                                  CGFloat *done = (CGFloat)expectedSize;
//                                                                  CGFloat *all = (CGFloat)expectedSize;
